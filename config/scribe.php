...
return [
    ...
    'description' => 'REST API for Restaurant & Café Management SaaS — Egypt & MENA. All endpoints return JSON with a consistent envelope: { "data": {...}, "meta": { "message": "OK" } }. Error responses: { "errors": [{ "message": "...", "code": "ERROR_CODE" }] }',
    ...
    'auth' => [
        ...
        // The name of the auth parameter
        'name' => 'Authorization',

        // The value of the parameter to be used by Scribe to authenticate response calls.
        'use_value' => env('SCRIBE_AUTH_DEFAULT_VALUE'),

        // Placeholder your users will see for the auth parameter in the example requests.
        'placeholder' => '{YOUR_BEARER_TOKEN}',

        // Extra authentication-related info for your users.
        'extra_info' => 'Obtain a Bearer token from `POST /api/v1/auth/login`. For kitchen display devices use `POST /api/v1/auth/device/kitchen`. Include as: `Authorization: Bearer {token}`.',
    ],
